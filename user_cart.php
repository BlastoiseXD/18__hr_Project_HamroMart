            ...
            <table>
                ...
                <?php  
                    ...
                    if(mysqli_num_rows($select_cart) > 0){
                        // if the cart row is more than 0 fetch all details of cart
                ...
                <?php
                    //Generating bill 
                    $b_name = $fetch_cart['name'];
                    $b_price = $p_price;
                    $b_quantity = $p_qauntity;
                    $total = $sub_total;
                    
                    // Prepare SQL statement to insert data into the "bill" table
                    $sql = "INSERT INTO bill (name, price, quantity, total) VALUES ('$b_name', $b_price, $b_quantity, $total)";
